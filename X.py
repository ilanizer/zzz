    ...
    try:
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                    tanya = msg.text.replace("@"+cl.getProfile().displayName,"Bah [Tag] Lagi")
                    jawaban = (tanya)                                    
                    cl.sendText(msg.to,jawaban)
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "ZZZ")
                    ...
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "ZZZ")
                    cl.sendText(msg.to, "Salahkan yang Tag Diatas ZZZ")
        if op.type == 25:
            msg = op.message
